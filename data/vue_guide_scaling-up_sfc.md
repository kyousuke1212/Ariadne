...
如你所见，Vue 的单文件组件是网页开发中 HTML、CSS 和 JavaScript 三种语言经典组合的自然延伸。、 和  三个块在同一个文件中封装、组合了组件的视图、逻辑和样式。完整的语法定义可以查阅单文件组件语法说明。
## 为什么要使用单文件组件 
...
单文件组件中的  标签一般会在开发时注入成原生的  标签以支持热更新，而生产环境下它们会被抽取、合并成单独的 CSS 文件。
