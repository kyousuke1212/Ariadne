...
```
App.jsApp.jsReloadClearForkexport default function Avatar() {
  return (
    <img
      className="avatar"
...
```
App.jsApp.jsReloadClearForkconst today = new Date();
...
## 尝试一些挑战
1. 修复错误 2. 提取信息到对象中 3. 在 JSX 大括号内编写表达式
#### 第 1 个挑战 共 3 个挑战: 修复错误
