...
```
App.jsdata.jsApp.jsReloadClearForkimport { sculptureList } from './data.js';
...
```
index.jsindex.htmlindex.jsReloadClearForklet componentHooks = [];
...
```
App.jsGallery.jsdata.jsApp.jsReloadClearForkimport Gallery from './Gallery.js';
...
## 尝试一些挑战
1. 完成画廊组件 2. 修复卡住的输入表单 3. 修复一个错误 4. 移除不必要的 state
