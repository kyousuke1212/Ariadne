...
## 配置指南 
### Vite 
@vitejs/plugin-vue 会自动为这些标志提供默认值。要更改默认值，请使用 Vite 的 define 配置项：
js [vite.config.js]
...
### webpack 
应该使用 webpack 的 DefinePlugin 定义这些标志：
...
### Rollup 
应该使用 @rollup/plugin-replace 定义这些标志：
js [rollup.config.js]
