...
## 注册周期钩子 
举例来说，onMountedmounted 钩子可以用来在组件完成初始渲染并创建 DOM 节点后运行代码：
vue
...
!展示 Vue 组件完整生命周期的图示，从创建到销毁，包括所有主要的生命周期钩子以及模板编译和挂载等内部过程
有关所有生命周期钩子及其各自用例的详细信息，请参考生命周期钩子 API 索引生命周期钩子 API 索引。