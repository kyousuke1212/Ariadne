...
## 参考
### createRef()
在 class 组件 中调用 createRef 来声明一个 ref。
```
...
## 用法
### 在 class 组件中声明 ref
要在 class 组件 中声明一个 ref，请调用 createRef 并将其结果分配给 class 字段：
```
...
```
App.jsApp.jsReloadClearForkimport { Component, createRef } from 'react';
