...
```
App.jsApp.jsReloadClearForkfunction Avatar() {
  return (
    <img
      className="avatar"
...
```
App.jsAvatar.jsutils.jsApp.jsReloadClearForkimport Avatar from './Avatar.js';
...
尝试在下面的选择框中更改颜色：
```
Clock.jsClock.jsReloadClearForkexport default function Clock({ color, time }) {
  return (
...
## 尝试一些挑战
1. 提取一个组件 2. 根据 props 调整图像大小 3. 在 children prop 中传递 JSX 代码
