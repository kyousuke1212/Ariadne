...
###  \*\* 
在 setup() 函数中手动暴露大量的状态和方法非常繁琐。幸运的是，我们可以通过使用单文件组件 (SFC) 来避免这种情况。我们可以使用  来大幅度地简化代码：
vue{1}
...
在指南的后续章节中，我们基本上都会在组合式 API 示例中使用单文件组件 +  的语法，因为大多数 Vue 开发者都会这样使用。
